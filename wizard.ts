...
import { runPreflight, printHelp as phPreflight } from './src/cli/cmd-preflight.js';
import { runDryRun,   printHelp as phDryRun }   from './src/cli/cmd-dry-run.js';
import { runPreview,  printHelp as phPreview }  from './src/cli/cmd-preview.js';
import { runPromote,  printHelp as phPromote }  from './src/cli/cmd-promote.js';
import { runBatch,    printHelp as phBatch }    from './src/cli/cmd-batch.js';
import { runServe,    printHelp as phServe }    from './src/cli/cmd-serve.js';
import { runPipeline, printHelp as phPipeline } from './src/cli/cmd-pipeline.js';
import { runDoctor,   printHelp as phDoctor }   from './src/cli/cmd-doctor.js';
